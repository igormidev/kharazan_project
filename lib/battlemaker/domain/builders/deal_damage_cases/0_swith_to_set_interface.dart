...
class SwithToSetDamageInterface {
  SwithToSetDamageInterface({
  ...
  SetDealDamageNonFatal setIfDamageDosentKillTargetPiece() {
    return SetDealDamageNonFatal(
      moveActions: _moveAction,
      willExecuteDamageNonFatalCase: _willExecuteDamageNonFatalCase,
